...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, aud: $aud, role: $role, email: $email, emailConfirmedAt: $emailConfirmedAt, phone: $phone, confirmationSentAt: $confirmationSentAt, confirmedAt: $confirmedAt, lastSignInAt: $lastSignInAt, appMetadata: $appMetadata, userMetadata: $userMetadata, identities: $identities, createdAt: $createdAt, updatedAt: $updatedAt, isAnonymous: $isAnonymous)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      @JsonKey(name: 'is_anonymous')
      final bool? isAnonymous}) = _$UserModelImpl;
